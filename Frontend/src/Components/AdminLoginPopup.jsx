  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload =
        formState === "Sign Up"
          ? {
              ...
              roles: ["admin"], // Add the 'admin' role during sign up
            }
      ...
      if (formState === "Sign Up" && response.status === 200) {
        setSuccessMessage("Admin registered successfully!"); // Show success message
        setTimeout(() => navigate("/admin-dashboard"), 2000); // Navigate after 2 seconds
      }
